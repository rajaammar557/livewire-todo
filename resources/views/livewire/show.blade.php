<div wire:key="{{ $todo->id }}"
    class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500
    hover:shadow">
    <div class="flex justify-between space-x-2">
        <div class="flex items-center space-x-3">
            ...
            @else
                ...
                @if ($todo->completed)
                    <input wire:click='completion({{ $todo->id }})' type="checkbox" id="completed" checked>
                @else
                    <input wire:click='completion({{ $todo->id }})' type="checkbox" id="not-Completed">
                @endif
        ...
        <div class="flex items-center space-x-2">
            ...
            <button wire:click="destroy({{ $todo->id }})" wire:confirm="Are you sure you want to delete this todo?"
